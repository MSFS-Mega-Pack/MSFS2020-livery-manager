...
export function checkAirplaneObject(airplaneObject) {
    ...
    if (airplaneObject.kb_checklists == undefined || typeof airplaneObject.kb_checklists != 'string') airplaneObject.kb_checklists = "Boeing747-400_check";
    if (airplaneObject.kb_reference == undefined || typeof airplaneObject.kb_reference != 'string') airplaneObject.kb_reference = "Boeing747-400_ref";
    if (airplaneObject.description == undefined || typeof airplaneObject.description != 'string') airplaneObject.description = "TT:AIRCRAFT.DESCRIPTION";
    if (airplaneObject.wip_indicator == undefined || typeof airplaneObject.wip_indicator != 'number') airplaneObject.wip_indicator = 0;
    if (airplaneObject.ui_manufacturer == undefined || typeof airplaneObject.ui_manufacturer != 'string') airplaneObject.ui_manufacturer = "TT:AIRCRAFT.UI_MANUFACTURER";
    ...
    if (airplaneObject.ui_typerole == undefined || typeof airplaneObject.ui_typerole != 'string') airplaneObject.ui_typerole = "Commercial Airliner";
    ...
    if (airplaneObject.ui_certified_ceiling == undefined || typeof airplaneObject.ui_certified_ceiling != 'number') airplaneObject.ui_certified_ceiling = 39800;
    ...
    if (airplaneObject.ui_fuel_burn_rate == undefined || typeof airplaneObject.ui_fuel_burn_rate != 'number') airplaneObject.ui_fuel_burn_rate = 5300;
    ...
    if (airplaneObject.atc_flight_number == undefined || typeof airplaneObject.atc_flight_number != 'string') airplaneObject.atc_flight_number = "1123";
    if (airplaneObject.atc_heavy == undefined || typeof airplaneObject.atc_heavy != 'number') airplaneObject.atc_heavy = 1;
    if (airplaneObject.atc_parking_types == undefined || typeof airplaneObject.atc_parking_types != 'string') airplaneObject.atc_heavy = "GATE,RAMP,CARGO";
    if (airplaneObject.atc_parking_codes == undefined || typeof airplaneObject.atc_parking_codes != 'string') airplaneObject.atc_parking_codes = "";
